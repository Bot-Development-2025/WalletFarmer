...
export const depositToSubWallet = async (
  privateKey,
  ...
  console.log(
    `${ethers.formatEther(
      ethers.parseEther(defaultAmount.toString())
    )} will be deposit`
  );
  ...
  console.log(`Transaction Hash: https://etherscan.io/tx/${transaction.hash}`);
  return `Address: ${wallet.address}\nPrivateKey: ${privateKey}\nSend ${defaultAmount} ETH to wallet: ${wallet.address}\nTracsaction Hash: https://etherscan.io/tx/${transaction.hash}\n`;
};
